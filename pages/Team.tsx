...
const Team: React.FC<TeamProps> = ({ lang, members }) => {
  ...
  return (
    <div className={`py-20 md:py-24 ${isRtl ? 'font-arabic text-right' : 'font-sans text-left'} bg-slate-50 dark:bg-slate-900 min-h-screen transition-colors duration-500`}>
                ...
                <div className="flex overflow-x-auto gap-2 custom-scrollbar no-scrollbar items-center px-2">
                    {offices.map(office => (
                        <button
                            ...
                            className={`flex-shrink-0 px-6 py-3 rounded-xl font-bold whitespace-nowrap transition-all border ${
